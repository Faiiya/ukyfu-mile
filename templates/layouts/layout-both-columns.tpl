...
<html lang="{$language.iso_code}">
  ...
  <body id="{$page.page_name}" class="{$page.body_classes|classnames}">
    ...
    <main>
      ...
      <div class="tw-px-5 tw-sticky tw-top-0 tw-z-50 tw-bg-white">
      ...
      {block name='wrapper'}
        {if $page.page_name == 'index'}
          {hook h="displayContentBeforeWrapper"}
        {/if}
        <section id="wrapper" class="mt-4 {block name='layoutWrapperClass'}l-wrapper{/block}">
