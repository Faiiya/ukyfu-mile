...
<section class="featured-categories">
  <p class="products-section-title">
    {l s='Categorias Populares' d='Shop.Theme.Catalog'}
  </p>
  <div class="tw-flex tw-flex-col md:tw-flex-row">
      <div class="">
        <a href="{url entity='category' id=3}">
          <img src="https://dummyimage.com/500x500/500/fff"/>
        </a>   
      </div>
      <div class="tw-flex tw-flex-col">
        <div class=""><a href="{url entity='category' id=3}"><img src="https://dummyimage.com/610x250/000/fff/"></a></div>
        <div class=""><a href="{url entity='category' id=3}"><img src="https://dummyimage.com/610x250/123/fff/"></a></div>
      </div>
  </div>
</section>
